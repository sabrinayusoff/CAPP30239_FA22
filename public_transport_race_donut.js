/* This script creates a donut chart showing the breakdown of people using public transportation
by race. */

d3.csv("data/public_transport_race.csv").then(data => {
    ...
    const svg = d3.select("#public-transport-donut")
      .append("svg")
      .attr("width", width)
      .attr("height", height)
    ...
    svg.append("g")
      ...
      .selectAll("tspan")
      .data(d => {
        return [d.data.race, d3.format(",")(d.data.count), `(${d.data.percent}%)`];
      })
